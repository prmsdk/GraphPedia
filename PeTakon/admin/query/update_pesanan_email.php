...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
    Pesanan anda telah selesai dikerjakan dan siap untuk dikirimkan...
</div>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 32px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 10px;" class="padding-copy">Pesanan Anda Telah Selesai!</td>
                            </tr>
                            <tr>
                                <td align="justify" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Hai '.$user_nama.',<br><br> Pesanan anda telah selesai dikerjakan dan siap untuk dikirimkan, pengiriman akan dilakukan pada alamat dibawah ini :</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td valign="top" class="mobile-wrapper">
                                    <!-- LEFT COLUMN -->
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 20%;" align="left">
                                        <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 80%;" align="left">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="justify" style="font-family: Arial, sans-serif; color: #333333; font-size: 16px;">'.$user_alamat.'</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="padding: 0 0 0 0; font-size: 14px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color: #aaaaaa; font-style: italic;" class="padding-copy">Mohon periksa alamat yang tertera diatas, jika alamat yang tertera pada website kami tidak sama dengan alamat anda, mohon ubah alamat pada profil anda atau hubungi kami melalui Telepon/WhatsApp.</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
