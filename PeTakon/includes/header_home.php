...
<body>
    ...
    <header id="info">
      <div class="row bg-dark p-2">
        <div class="col-lg-8 col-md-12 text-lg-left text-sm-center" style="z-index:19; color:#fff">
          Buka Senin - Sabtu Jam 09.000 - 20.00 <span style="color: #a1a1a1">(Hari Minggu dan Hari Besar Libur)
        </div>
        <div class="col-lg-4 col-md-12 text-lg-right text-sm-center" style="z-index:19; color:#fff">
          <i class="fa fa-phone"></i> (0331) 412990
        </div>
      </div>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          ...
          <!-- FOTO PROFIL -->
            ...
            <!-- BATAS FOTO -->
            <div class="dropdown-menu overflow-auto dropdown-menu-right text-right">
    ...
    <nav id="logo" class="m-0 navbar navbar-expand-lg navbar-dark nav-tr">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          ...
          <a class="nav-item nav-link nav-custom" href="index.php#testimonibtn">TESTIMONI</a>
          <a class="nav-item nav-link nav-custom" href="index.php#contact">HUBUNGI KAMI</a>
            <button type="button" class="btn rounded-0 nav-item nav-custom mr-auto" data-toggle="modal" data-target="#login_user" style="color: #25A8E0">
            MASUK
            </button>
